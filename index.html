...
<body class="d-flex justify-content-center flex-column g-5">
  ...
  <div id="ris" class="container-fluid my-5 py-5">
    ...
    <div id="div-ris" class="rounded-5 p-5 w-50 position-relative col-12">
      ...
      <img id="immagina-ris" class="rounded-5" src="http://dumpfinder.altervista.org/indexImg/risultati.jpg"
            alt="">
      </div>

      <div class="d-flex justify-content-end" id="div-h1-ris">
        <h1>Risultati</h1>
      </div>
      <!-- CONTENUTO RISULTATI -->
  ...
  <div
    class="container p-5 bg-light border-primary d-flex justify-content-center rounded align-items-center w-25 h-25 mb-5">
  ...
  <footer class="footer mt-5 d-flex">
    ...
    <div class="menu row p-2 z-3">
      <div class="col menu__item"><a class="menu__link" href="#"><img class="social_logo"
            src="img/logo/instagram_logo.svg" alt="instagram_logo"></a></div>
      <div class="col menu__item"><a class="menu__link" href="#"><img class="social_logo"
            src="img/logo/facebook_logo.svg" alt="facebook_logo"></a></div>
    </div>
